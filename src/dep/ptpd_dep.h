...
#define PTPD_DBG
#define PTPD_ERR
#define DBGVV(...) chprintf((BaseSequentialStream*)(&SD3), "(V) " __VA_ARGS__)
#else
#define DBGVV(...)
#endif
...
#define PTPD_DBG
#define PTPD_ERR
#define DBGV(...)  { TimeInternal tmpTime; getTime(&tmpTime); chprintf((BaseSequentialStream*)(&SD3), "(d %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); chprintf((BaseSequentialStream*)(&SD3),__VA_ARGS__); }
#else
#define DBGV(...)
#endif
...
#ifdef PTPD_DBG
#define PTPD_ERR
#define DBG(...)  { TimeInternal tmpTime; getTime(&tmpTime); chprintf((BaseSequentialStream*)(&SD3), "(D %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); chprintf((BaseSequentialStream*)(&SD3),__VA_ARGS__); }
#else
#define DBG(...)
#endif
/** \}*/
...
/**\{*/
#ifdef PTPD_ERR
#define ERROR(...)  { TimeInternal tmpTime; getTime(&tmpTime); chprintf((BaseSequentialStream*)(&SD3), "(E %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); chprintf((BaseSequentialStream*)(&SD3),__VA_ARGS__); }
